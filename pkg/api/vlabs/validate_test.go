...
func Test_OrchestratorProfile_Validate(t *testing.T) {
	tests := map[string]struct {
		...
		"should error when KubernetesConfig has invalid containerd version for containerd runtime": {
			...
			expectedError: "Invalid containerd version \"1.0.0\", please use one of the following versions: [1.3.2 1.3.3 1.3.4 1.3.5 1.3.6 1.3.7 1.3.8 1.3.9 1.4.4 1.4.6 1.4.7 1.4.8 1.4.9 1.4.11 1.5.11 1.5.13 1.5.16 1.6.21 1.6.28 1.6.36 1.7.27]",
		},
