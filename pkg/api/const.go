...
const (
	...
	DefaultContainerdVersion = "1.6.35"
	...
	DefaultWindowsContainerdURL = "https://mobyartifacts.azureedge.net/moby/moby-containerd/1.6.35+azure/windows/windows_amd64/moby-containerd-1.6.35+azure-u1.amd64.zip"
)
