...
const (
	...
	csiProvisionerImageReference                      string = "oss/kubernetes-csi/csi-provisioner:v3.3.0"
	csiAttacherImageReference                         string = "oss/kubernetes-csi/csi-attacher:v4.0.0"
	csiLivenessProbeImageReference                    string = "oss/kubernetes-csi/livenessprobe:v2.8.0"
	csiLivenessProbeWindowsImageReference             string = "oss/kubernetes-csi/livenessprobe:v2.8.0"
	csiNodeDriverRegistrarImageReference              string = "oss/kubernetes-csi/csi-node-driver-registrar:v2.6.2"
	csiNodeDriverRegistrarWindowsImageReference       string = "oss/kubernetes-csi/csi-node-driver-registrar:v2.6.2"
	csiResizerImageReference                          string = "oss/kubernetes-csi/csi-resizer:v1.6.0"
	csiSnapshotterImageReference                      string = "oss/kubernetes-csi/csi-snapshotter:v5.0.1"
	csiSnapshotControllerImageReference               string = "oss/kubernetes-csi/snapshot-controller:v5.0.1"
