...
var kubernetesImageBaseVersionedImages = map[string]map[string]map[string]string{
	common.KubernetesImageBaseTypeGCR: {
		"1.33": {
			common.CSIProvisionerContainerName:                "oss/kubernetes-csi/csi-provisioner:v5.3.0",
			common.CSIAttacherContainerName:                   "oss/kubernetes-csi/csi-attacher:v4.10.0",
			common.CSILivenessProbeContainerName:              "oss/kubernetes-csi/livenessprobe:v2.17.0",
			common.CSILivenessProbeWindowsContainerName:       "oss/kubernetes-csi/livenessprobe:v2.17.0",
			common.CSINodeDriverRegistrarContainerName:        "oss/kubernetes-csi/csi-node-driver-registrar:v2.15.0",
			common.CSINodeDriverRegistrarWindowsContainerName: "oss/kubernetes-csi/csi-node-driver-registrar:v2.15.0",
			...
			common.CSIResizerContainerName:                    "oss/kubernetes-csi/csi-resizer:v1.14.0",
			common.CSIAzureDiskContainerName:                  "oss/kubernetes-csi/azuredisk-csi:v1.33.5",
		...
		"1.32": {
			...
			common.CSIAzureDiskContainerName:                  "oss/kubernetes-csi/azuredisk-csi:v1.32.11",
			common.AddonResizerComponentName:                  "addon-resizer:1.8.7",
		...
		"1.31": {
			...
			common.CSIResizerContainerName:                    "oss/kubernetes-csi/csi-resizer:v1.13.2",
			common.CSIAzureDiskContainerName:                  "oss/kubernetes-csi/azuredisk-csi:v1.31.12",
