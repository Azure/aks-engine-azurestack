...
func getK8sVersionComponents(version, kubernetesImageBaseType string, overrides map[string]string) map[string]string {
	...
	case "1.35":
		ret = map[string]string{
			...
			common.CloudControllerManagerComponentName:    "oss/v2/kubernetes/azure-cloud-controller-manager:v1.35.3",
			common.CloudNodeManagerAddonName:              "oss/v2/kubernetes/azure-cloud-node-manager:v1.35.3",
