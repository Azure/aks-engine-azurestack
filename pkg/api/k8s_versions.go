...
var kubernetesImageBaseVersionedImages = map[string]map[string]map[string]string{
	common.KubernetesImageBaseTypeGCR: {
		...
		"1.33": {
			...
			common.CSIAzureDiskContainerName:                  "oss/v2/kubernetes-csi/azuredisk-csi:v1.33.2",
			common.CSIAzureDiskWindowsHpContainerName:         "oss/v2/kubernetes-csi/azuredisk-csi:v1.33.2-windows-hp",
