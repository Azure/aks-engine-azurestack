...
var kubernetesImageBaseVersionedImages = map[string]map[string]map[string]string{
	common.KubernetesImageBaseTypeGCR: {
		"1.35": {
			common.CSIProvisionerContainerName:                "oss/v2/kubernetes-csi/csi-provisioner:v6.2.0",
			common.CSIAttacherContainerName:                   "oss/v2/kubernetes-csi/csi-attacher:v4.11.0",
			common.CSILivenessProbeContainerName:              "oss/v2/kubernetes-csi/livenessprobe:v2.18.0",
		...
		"1.33": {
			common.CSIProvisionerContainerName:                "oss/v2/kubernetes-csi/csi-provisioner:v6.0.0",
			common.CSIAttacherContainerName:                   "oss/v2/kubernetes-csi/csi-attacher:v4.10.0",
			common.CSILivenessProbeContainerName:              "oss/v2/kubernetes-csi/livenessprobe:v2.17.0",
			common.CSILivenessProbeWindowsContainerName:       "oss/v2/kubernetes-csi/livenessprobe:v2.17.0",
			common.CSINodeDriverRegistrarContainerName:        "oss/v2/kubernetes-csi/csi-node-driver-registrar:v2.15.0",
			common.CSINodeDriverRegistrarWindowsContainerName: "oss/v2/kubernetes-csi/csi-node-driver-registrar:v2.15.0",
			common.CSISnapshotterContainerName:                "oss/v2/kubernetes-csi/csi-snapshotter:v8.4.0",
			common.CSISnapshotControllerContainerName:         "oss/v2/kubernetes-csi/snapshot-controller:v8.4.0",
			common.CSIResizerContainerName:                    "oss/v2/kubernetes-csi/csi-resizer:v2.0.0",
			common.CSIAzureDiskContainerName:                  "oss/v2/kubernetes-csi/azuredisk-csi:v1.33.7",
			common.CSIAzureDiskWindowsHpContainerName:         "oss/v2/kubernetes-csi/azuredisk-csi:v1.33.7-windows-hp",
			common.AddonResizerComponentName:                  "addon-resizer:1.8.7",
			common.MetricsServerAddonName:                     "metrics-server/metrics-server:v0.5.2",
			common.AddonManagerComponentName:                  "kube-addon-manager-amd64:v9.1.6",
			common.ClusterAutoscalerAddonName:                 "cluster-autoscaler:v1.22.1",
		...
		"1.32": {
			common.CSIProvisionerContainerName:                "oss/v2/kubernetes-csi/csi-provisioner:v5.2.0",
			common.CSIAttacherContainerName:                   "oss/v2/kubernetes-csi/csi-attacher:v4.8.1",
			common.CSILivenessProbeContainerName:              "oss/v2/kubernetes-csi/livenessprobe:v2.15.0",
			common.CSILivenessProbeWindowsContainerName:       "oss/v2/kubernetes-csi/livenessprobe:v2.15.0",
			common.CSINodeDriverRegistrarContainerName:        "oss/v2/kubernetes-csi/csi-node-driver-registrar:v2.13.0",
			common.CSINodeDriverRegistrarWindowsContainerName: "oss/v2/kubernetes-csi/csi-node-driver-registrar:v2.13.0",
			common.CSISnapshotterContainerName:                "oss/kubernetes-csi/csi-snapshotter:v8.2.1",
			common.CSISnapshotControllerContainerName:         "oss/kubernetes-csi/snapshot-controller:v8.2.1",
			common.CSIResizerContainerName:                    "oss/v2/kubernetes-csi/csi-resizer:v1.13.2",
			common.CSIAzureDiskContainerName:                  "oss/v2/kubernetes-csi/azuredisk-csi:v1.32.11",
			common.CSIAzureDiskWindowsHpContainerName:         "oss/v2/kubernetes-csi/azuredisk-csi:v1.32.11-windows-hp",
			common.AddonResizerComponentName:                  "addon-resizer:1.8.7",
			common.MetricsServerAddonName:                     "metrics-server/metrics-server:v0.5.2",
			common.AddonManagerComponentName:                  "kube-addon-manager-amd64:v9.1.6",
			common.ClusterAutoscalerAddonName:                 "cluster-autoscaler:v1.22.1",
		...
		"1.31": {
			...
			common.CSIResizerContainerName:                    "oss/v2/kubernetes-csi/csi-resizer:v1.13.2",
			common.CSIAzureDiskContainerName:                  "oss/v2/kubernetes-csi/azuredisk-csi:v1.31.12",
			common.CSIAzureDiskWindowsHpContainerName:         "oss/v2/kubernetes-csi/azuredisk-csi:v1.31.12-windows-hp",
			common.AddonResizerComponentName:                  "addon-resizer:1.8.7",
			common.MetricsServerAddonName:                     "metrics-server/metrics-server:v0.5.2",
			common.AddonManagerComponentName:                  "kube-addon-manager-amd64:v9.1.6",
			common.ClusterAutoscalerAddonName:                 "cluster-autoscaler:v1.22.1",
		...
		"1.30": {
			common.CSIProvisionerContainerName:                "oss/kubernetes-csi/csi-provisioner:v5.1.0",
			common.CSIAttacherContainerName:                   "oss/kubernetes-csi/csi-attacher:v4.7.0",
			common.CSILivenessProbeContainerName:              "oss/kubernetes-csi/livenessprobe:v2.14.0",
			common.CSILivenessProbeWindowsContainerName:       "oss/kubernetes-csi/livenessprobe:v2.14.0",
			common.CSINodeDriverRegistrarContainerName:        "oss/kubernetes-csi/csi-node-driver-registrar:v2.12.0",
			common.CSINodeDriverRegistrarWindowsContainerName: "oss/kubernetes-csi/csi-node-driver-registrar:v2.12.0",
			common.CSISnapshotterContainerName:                "oss/kubernetes-csi/csi-snapshotter:v8.1.0",
			common.CSISnapshotControllerContainerName:         "oss/kubernetes-csi/snapshot-controller:v8.1.0",
			common.CSIResizerContainerName:                    "oss/kubernetes-csi/csi-resizer:v1.12.0",
			common.CSIAzureDiskContainerName:                  "oss/kubernetes-csi/azuredisk-csi:v1.29.12",
			common.AddonResizerComponentName:                  "addon-resizer:1.8.7",
			common.MetricsServerAddonName:                     "metrics-server/metrics-server:v0.5.2",
			common.AddonManagerComponentName:                  "kube-addon-manager-amd64:v9.1.6",
			common.ClusterAutoscalerAddonName:                 "cluster-autoscaler:v1.22.1",
	...
	common.KubernetesImageBaseTypeMCR: {
		// For next release of k8s 1.35 and later versions, all csi images (including csi-snapshotter and snapshot-controller) can switch to v2 path
		"1.35": {
			common.CSIProvisionerContainerName:                "oss/v2/kubernetes-csi/csi-provisioner:v6.2.0",
			common.CSIAttacherContainerName:                   "oss/v2/kubernetes-csi/csi-attacher:v4.11.0",
			common.CSILivenessProbeContainerName:              "oss/v2/kubernetes-csi/livenessprobe:v2.18.0",
		...
		// For next release of k8s 1.34 and later versions, all csi images (including csi-snapshotter and snapshot-controller) can switch to v2 path
		"1.34": {
			common.CSIProvisionerContainerName:                "oss/v2/kubernetes-csi/csi-provisioner:v6.2.0",
			common.CSIAttacherContainerName:                   "oss/v2/kubernetes-csi/csi-attacher:v4.11.0",
			common.CSILivenessProbeContainerName:              "oss/v2/kubernetes-csi/livenessprobe:v2.18.0",
...
func getK8sVersionComponents(version, kubernetesImageBaseType string, overrides map[string]string) map[string]string {
	...
	case "1.35":
		ret = map[string]string{
			...
			common.CloudControllerManagerComponentName:    "oss/kubernetes/azure-cloud-controller-manager:v1.35.3",
			common.CloudNodeManagerAddonName:              "oss/kubernetes/azure-cloud-node-manager:v1.35.3",
			...
			common.CSIAzureDiskWindowsHpContainerName:         k8sComponent[common.CSIAzureDiskWindowsHpContainerName],
	...
	case "1.34":
		ret = map[string]string{
			...
			common.KubeProxyAddonName:                     getDefaultImage(common.KubeProxyAddonName, kubernetesImageBaseType) + ":v" + version,
			common.SchedulerComponentName:                 getDefaultImage(common.SchedulerComponentName, kubernetesImageBaseType) + ":v" + version,
			common.CloudControllerManagerComponentName:    "oss/kubernetes/azure-cloud-controller-manager:v1.34.8",
			common.CloudNodeManagerAddonName:              "oss/kubernetes/azure-cloud-node-manager:v1.34.8",
			common.WindowsArtifactComponentName:           "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.WindowsArtifactAzureStackComponentName: "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.DashboardAddonName:                     dashboardImageReference,
			common.DashboardMetricsScraperContainerName:   dashboardMetricsScraperImageReference,
	...
	case "1.33":
		ret = map[string]string{
			...
			common.KubeProxyAddonName:                     getDefaultImage(common.KubeProxyAddonName, kubernetesImageBaseType) + ":v" + version,
			common.SchedulerComponentName:                 getDefaultImage(common.SchedulerComponentName, kubernetesImageBaseType) + ":v" + version,
			common.CloudControllerManagerComponentName:    "oss/kubernetes/azure-cloud-controller-manager:v1.33.1",
			common.CloudNodeManagerAddonName:              "oss/kubernetes/azure-cloud-node-manager:v1.33.0",
			common.WindowsArtifactComponentName:           "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.WindowsArtifactAzureStackComponentName: "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.DashboardAddonName:                     dashboardImageReference,
			common.DashboardMetricsScraperContainerName:   dashboardMetricsScraperImageReference,
	...
	case "1.32":
		ret = map[string]string{
			...
			common.KubeProxyAddonName:                     getDefaultImage(common.KubeProxyAddonName, kubernetesImageBaseType) + ":v" + version,
			common.SchedulerComponentName:                 getDefaultImage(common.SchedulerComponentName, kubernetesImageBaseType) + ":v" + version,
			common.CloudControllerManagerComponentName:    "oss/kubernetes/azure-cloud-controller-manager:v1.32.6",
			common.CloudNodeManagerAddonName:              "oss/kubernetes/azure-cloud-node-manager:v1.32.5",
			common.WindowsArtifactComponentName:           "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.WindowsArtifactAzureStackComponentName: "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.DashboardAddonName:                     dashboardImageReference,
			common.DashboardMetricsScraperContainerName:   dashboardMetricsScraperImageReference,
	...
	case "1.31":
		ret = map[string]string{
			...
			common.CloudNodeManagerAddonName:              "oss/kubernetes/azure-cloud-node-manager:v1.31.6",
			common.WindowsArtifactComponentName:           "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.WindowsArtifactAzureStackComponentName: "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.DashboardAddonName:                     dashboardImageReference,
			common.DashboardMetricsScraperContainerName:   dashboardMetricsScraperImageReference,
