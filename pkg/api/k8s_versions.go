...
var kubernetesImageBaseVersionedImages = map[string]map[string]map[string]string{
	common.KubernetesImageBaseTypeGCR: {
		...
		"1.33": {
			...
			common.CSIAzureDiskContainerName:                  "docker.io/andyzhangx/azuredisk-csi:v1.34.0",
			common.CSIAzureDiskWindowsHpContainerName:         "oss/kubernetes-csi/azuredisk-csi:v1.33.2-windows-hp",
