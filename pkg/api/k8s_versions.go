...
var kubernetesImageBaseVersionedImages = map[string]map[string]map[string]string{
	common.KubernetesImageBaseTypeGCR: {
		...
		"1.33": {
			common.CSIProvisionerContainerName:                "oss/v2/kubernetes-csi/csi-provisioner:v5.3.0",
			...
			common.CSISnapshotterContainerName:                "oss/kubernetes-csi/csi-snapshotter:v8.3.0",
			common.CSISnapshotControllerContainerName:         "oss/kubernetes-csi/snapshot-controller:v8.3.0",
			common.CSIResizerContainerName:                    "oss/v2/kubernetes-csi/csi-resizer:v1.14.0",
			common.CSIAzureDiskContainerName:                  "oss/v2/kubernetes-csi/azuredisk-csi:v1.33.5",
			common.CSIAzureDiskWindowsHpContainerName:         "oss/v2/kubernetes-csi/azuredisk-csi:v1.33.5-windows-hp",
			common.AddonResizerComponentName:                  "addon-resizer:1.8.7",
			common.MetricsServerAddonName:                     "metrics-server/metrics-server:vv0.5.2",
