...
func getK8sVersionComponents(version, kubernetesImageBaseType string, overrides map[string]string) map[string]string {
	...
	case "1.35":
		ret = map[string]string{
			...
			common.CloudControllerManagerComponentName:    "oss/v2/kubernetes/azure-cloud-controller-manager:v1.35.4",
			common.CloudNodeManagerAddonName:              "oss/v2/kubernetes/azure-cloud-node-manager:v1.35.4",
	...
	case "1.33":
		ret = map[string]string{
			...
			common.KubeProxyAddonName:                     "oss/v2/kubernetes/kube-proxy:v" + version,
			common.SchedulerComponentName:                 "oss/v2/kubernetes/kube-scheduler:v" + version,
			common.CloudControllerManagerComponentName:    "oss/v2/kubernetes/azure-cloud-controller-manager:v1.33.1",
			common.CloudNodeManagerAddonName:              "oss/v2/kubernetes/azure-cloud-node-manager:v1.33.1",
			common.WindowsArtifactComponentName:           "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.WindowsArtifactAzureStackComponentName: "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.DashboardAddonName:                     dashboardImageReference,
			common.DashboardMetricsScraperContainerName:   dashboardMetricsScraperImageReference,
