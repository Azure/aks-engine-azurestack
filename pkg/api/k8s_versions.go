...
var kubernetesImageBaseVersionedImages = map[string]map[string]map[string]string{
	common.KubernetesImageBaseTypeGCR: {
		"1.32": {
			common.CSIProvisionerContainerName:                "oss/kubernetes-csi/csi-provisioner:v5.1.20",
			common.CSIAttacherContainerName:                   "oss/kubernetes-csi/csi-attacher:v4.7.20",
			common.CSILivenessProbeContainerName:              "oss/kubernetes-csi/livenessprobe:v2.14.20",
			common.CSILivenessProbeWindowsContainerName:       "oss/kubernetes-csi/livenessprobe:v2.14.20",
			common.CSINodeDriverRegistrarContainerName:        "oss/kubernetes-csi/csi-node-driver-registrar:v2.12.20",
			common.CSINodeDriverRegistrarWindowsContainerName: "oss/kubernetes-csi/csi-node-driver-registrar:v2.12.20",
			common.CSISnapshotterContainerName:                "oss/kubernetes-csi/csi-snapshotter:v8.1.20",
			common.CSISnapshotControllerContainerName:         "oss/kubernetes-csi/snapshot-controller:v8.1.20",
			common.CSIResizerContainerName:                    "oss/kubernetes-csi/csi-resizer:v1.12.20",
			common.CSIAzureDiskContainerName:                  "oss/kubernetes-csi/azuredisk-csi:v1.29.20",
			common.AddonResizerComponentName:                  "addon-resizer:1.8.20",
			common.MetricsServerAddonName:                     "metrics-server/metrics-server:v0.5.20",
			common.AddonManagerComponentName:                  "kube-addon-manager-amd64:v9.1.20",
			common.ClusterAutoscalerAddonName:                 "cluster-autoscaler:v1.22.20",
		},
		"1.31": {
	...
	common.KubernetesImageBaseTypeMCR: {
		"1.32": {
			...
			common.CSIResizerContainerName:                    "oss/kubernetes-csi/csi-resizer:v1.12.20",
			common.CSIAzureDiskContainerName:                  "oss/kubernetes-csi/azuredisk-csi:v1.29.20",
			common.AddonResizerComponentName:                  "oss/kubernetes/autoscaler/addon-resizer:1.8.20",
			common.MetricsServerAddonName:                     "oss/kubernetes/metrics-server:v0.5.20",
			common.AddonManagerComponentName:                  "oss/kubernetes/kube-addon-manager:v9.1.20",
			common.ClusterAutoscalerAddonName:                 "oss/kubernetes/autoscaler/cluster-autoscaler:v1.22.20",
		},
		"1.31": {
			common.CSIProvisionerContainerName:                "oss/kubernetes-csi/csi-provisioner:v5.1.0",
			common.CSIAttacherContainerName:                   "oss/kubernetes-csi/csi-attacher:v4.7.0",
...
func getK8sVersionComponents(version, kubernetesImageBaseType string, overrides map[string]string) map[string]string {
	...
	case "1.31":
		ret = map[string]string{
			...
			common.KubeProxyAddonName:                     getDefaultImage(common.KubeProxyAddonName, kubernetesImageBaseType) + ":v" + version,
			common.SchedulerComponentName:                 getDefaultImage(common.SchedulerComponentName, kubernetesImageBaseType) + ":v" + version,
			common.CloudControllerManagerComponentName:    "oss/kubernetes/azure-cloud-controller-manager:v1.31.1",
			common.CloudNodeManagerAddonName:              "oss/kubernetes/azure-cloud-node-manager:v1.31.1",
			common.WindowsArtifactComponentName:           "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.WindowsArtifactAzureStackComponentName: "v" + version + "/windowszip/v" + version + "-1int.zip",
			common.DashboardAddonName:                     dashboardImageReference,
			common.DashboardMetricsScraperContainerName:   dashboardMetricsScraperImageReference,
