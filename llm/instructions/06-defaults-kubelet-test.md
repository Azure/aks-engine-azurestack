...
- In the **TestKubeletConfigFeatureGates** function, search for the variable named `featuregate[MAJOR][MINOR]` corresponding to the Kubernetes version (e.g., for version 1.30.10, look for `featuregate130`).
