...
$global:containerdPackageUrl = "https://mobyartifacts.azureedge.net/moby/moby-containerd/1.7.27+azure/windows/windows_amd64/moby-containerd-1.7.27+azure-u1.amd64.zip"
...
function Get-ContainerImages {
    ...
    $imagesToPull = @(
        ...
        "mcr.microsoft.com/oss/kubernetes-csi/azuredisk-csi:v1.29.14-windows-hp",
