...
$global:containerdPackageUrl = "https://mobyartifacts.azureedge.net/moby/moby-containerd/1.6.35+azure/windows/windows_amd64/moby-containerd-1.6.35+azure-u1.amd64.zip"
...
function Get-FilesToCacheOnVHD {
    ...
    $map = @{
        ...
        "c:\akse-cache\win-k8s\"      = @(
            ...
            "https://kubernetesartifacts.azureedge.net/kubernetes/v1.29.8/windowszip/v1.29.8-1int.zip"
        );
