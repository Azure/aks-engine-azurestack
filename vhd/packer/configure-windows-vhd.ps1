...
$global:containerdPackageUrl = "https://acs-mirror.azureedge.net/containerd/windows/v1.6.21-azure.1/binaries/containerd-v1.6.21-azure.1-windows-amd64.tar.gz"
...
function Get-FilesToCacheOnVHD {
    ...
    $map = @{
        ...
        "c:\akse-cache\win-k8s\"      = @(
            "https://kubernetesartifacts.azureedge.net/kubernetes/v1.28.5/windowszip/v1.28.5-1int.zip",
            "https://kubernetesartifacts.azureedge.net/kubernetes/v1.27.9/windowszip/v1.27.9-1int.zip"
        );
